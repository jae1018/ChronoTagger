"""
CRUD operations and clear functionality for intervals.

This module contains all Create, Read, Update, Delete, and Clear operations
for interval management, including:
- Adding intervals with overlap detection and resolution
- Relabeling and deleting intervals
- Preview state management
- Clearing intervals in ranges with confirmation dialogs
- Snap-to-sample utilities
"""
...
class IntervalCRUDMixin:
    """Mixin providing CRUD operations for intervals."""
